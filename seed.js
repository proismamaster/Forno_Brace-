...
function seedPizzas() {
  ...
  const insert = db.prepare(
    `INSERT INTO pizzas (name, description, price, category, emoji, available)
     VALUES (@name, @description, @price, @category, @emoji, 1)`
  );
